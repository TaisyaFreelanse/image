    ...
    <section className="bg-white py-24 px-4 font-sans">
      <div className="container mx-auto max-w-7xl grid sm:grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-left">
          <h1 className="text-4xl sm:text-8xl font-extrabold text-gray-900 leading-tight mb-0">
            AI Image
          </h1>
          <h2 className="text-4xl sm:text-8xl font-extrabold text-[#3C82F4] leading-tight -mt-2 mb-6">
            Enhancer
          </h2>

          <p className="text-lg sm:text-base text-gray-700 mb-1">
            Remove watermarks or backgrounds{" "}
            <span className="bg-yellow-400 text-white font-normal px-4 py-1 rounded-full text-sm inline-block align-middle shadow-md rotate-[3deg]">
              with a single click
            </span>
          </p>

          <p className="text-lg sm:text-base text-gray-600 mb-8 -mt-1">
